...
<table id="table-1">
	<tr><td>
		 ...
		 <h4><a href="<%=request.getContextPath()%>/Manager/select_page.jsp"><img src="<%=request.getContextPath()%>/Manager/images/back1.gif" width="100" height="32" border="0">回首頁</a></h4>
	</td></tr>
</table>
	...
	<tr>
				...
				<td>
					<select name="status" size="1" id="s">
								<option value="1" <%=managerVO.getStatus()==1?"selected":""  %> >使用中</option>
								<option value="0" <%=managerVO.getStatus()==0?"selected":""  %> >停用中</option>
					</select>
				</td>
			</tr>
