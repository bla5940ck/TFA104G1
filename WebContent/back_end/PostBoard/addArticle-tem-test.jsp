...
<%-- <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back_end/Postborad/pb.do" name="form1"> --%>
...
<!-- 							<div class="col-md-6" id="col-md-6"> -->
								<div class="aa-myaccount-login" id="aa-myaccount-login">
									<h4>徵求發文</h4>
									<form  class="aa-login-form" METHOD="post" ACTION="<%=request.getContextPath()%>/back_end/Postborad/pb.do" name="form1">
										<label for="">會員編號<span>*</span></label><input 
										type="TEXT" name="memberId" value="${param.memberId}"/>
									
										<label for="">請輸入徵求標題<span>*</span></label> <input 
										type="TEXT" name="postTitle" value="${param.postTitle}" /> ${errorMsgs.postTitle}
											
											<label for="">項目分類<span>*</span></label><input 
											type="TEXT" name="categoryId" value="${param.categoryId}" />
...
<!-- 											type="text" placeholder="請選擇分類" name="categoryId"/> -->
											...
											name="posttime" id="date" type="text"></input>
											
										
										 <button type="submit" class="aa-browse-btn" name="action" value="insert"/>送出新增
