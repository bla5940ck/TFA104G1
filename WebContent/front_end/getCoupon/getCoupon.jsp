			...
			<script>
							...
							<center>
								<table>
									...
									<jsp:useBean id="promo"
										class="com.promo_list.model.PromolistService" />
										...
										<tr>
											...
											<td>
												<FORM METHOD="post" ACTION="getcoupon.do"
													...
													<input class="btn" type="submit" value="領取"> <input
														type="hidden" name="member_id" value="<%=memID%>">
													<input type="hidden" name="category_id"
														value="${promolistVO.category_id}"> <input
														type="hidden" name="coupon_id"
														value="${promolistVO.coupon_id}"> <input
														type="hidden" name="coupon_name"
														value="${promolistVO.coupon_name}"> <input
														type="hidden" name="discount"
														value="${promolistVO.discount}"> <input
														type="hidden" name="status" value="0"> <input
														type="hidden" name="start_date"
														value="${promolistVO.start_date}"> <input
														type="hidden" name="end_date"
														value="${promolistVO.end_date}"> <input
							...
							<center>
								<a
									href="<%=request.getContextPath()%>/front_end/getCoupon/game.jsp">
									<img
									src="<%=request.getContextPath()%>/front_end/getCoupon/img/game1.jpg"
									alt="">
								</a>
							</center>
