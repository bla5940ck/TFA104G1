...
<aside class="aside">
                    ...
                    <input type="text" name="loginId" placeholder="請輸入帳號">
                    <br>
                    <label for="">請輸入密碼<span>*</span></label>
                    <input type="password" name="password" placeholder="請輸入密碼">
                    <br>
                    <label for="">身分證字號<span>*</span></label>
                    <input type="text" name="idcn" placeholder="請輸入身分證字號">
                    <br>
                    <label for="">生日<span>*</span></label>
                    <input name="birthday" name="birthday" id="f_date1" type="text">
                    <br>
                    <label for="">手機號碼<span>*</span></label>
                    <input type="text" name="phoneNum" placeholder="請輸入手機號碼">
                    <br>
                    <label for="">請輸入Email<span>*</span></label>
                    <input type="text" name="email" placeholder="請輸入Email">
                    <br>
                    <label for="">請輸入郵遞區號<span>*</span></label>
                    <input type="text" name="addNum" placeholder="請輸入郵遞區號">
                    <br>
                    <label for="">縣市行政區<span>*</span></label>
                    <input type="text" name="add" placeholder="關聯郵遞區號預設帶入">
                    <br>
					...
					<br>
						...
						請上傳身分證正面:<input type="file" name="idcF" id="idcn_f" name="idcn_f" accept=".jpg, .jpeg, .png"><br>
						<div id="preview">
							<span class="text">預覽圖</span>
						</div>
						<br>
						請上傳身分證反面:<input type="file" name="idcB"id="idcn_b" name="idcn_b" accept=".jpg, .jpeg, .png"><br>
						<div id="preview">
							<span class="text">預覽圖</span>
						</div>
						<br>
