	...
	<FORM METHOD="post" ACTION="/TFA104G1/OrderMasterServlet" name="form1">
		<div class="main_content">
			...
			<main class="main">	
				...
				<div>
					<ul>
						<li>出租者評分 : <%=omVO.getLeaseRank() == 0 ? "尚未評分" : omVO.getLeaseRank()+"顆星"%></li>
						<li>出租者評論 : <%=omVO.getLeaseComt() == null || omVO.getLeaseComt().length() == 0 ? "尚未評分" : omVO.getLeaseComt()%></li>
					</ul>
				</div>
				<hr style="border: 1px solid black;">
				...
				<div class="mine">
					<ul>
						<li style="font-size: large;">我的評分 : <p id="rank"><%=omVO.getRentRank() == 0 ? "尚未評分" : omVO.getRentRank()+"顆星"%></p></li>
						<li style="font-size: large;">我的評論 : <p id="lc"><%=omVO.getRentComt() == null || omVO.getRentComt().length() == 0? "尚未評論" : omVO.getRentComt()%></p></li>
					</ul>
				</div>
				<div class="rankarea">
					<table id="review">
