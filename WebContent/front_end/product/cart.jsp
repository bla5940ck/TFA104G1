			...
			<div class="col-md-12">
				<div class="cart-view-area">
					<div class="cart-view-table">
						<form id="cart-form"
							action="<%=path%>/prod/ProdServlet?action=checkout"
							method="post">
							...
							%>
							<div id="lease-div">
								<label class="cart-lable" style="color: Navy; font-size: 30px;">賣場編號:
									shop1000<%=leaseID%>
								</label>
								...
								<div class="table-responsive">
									<table class="table">
										...
										<tbody>
											...
											<tr>
												<input class="leaseProd" type="hidden"
													value="<%=leaseProd%>">

											</tr>
											&nbsp;&nbsp;&nbsp;&nbsp;共
											<label id="prodCount_label" style="color: green;"><%=leaseProd%></label>
											件商品
										</tbody>
									</table>
								</div>
							...
							<td colspan="6" class="aa-cart-view-bottom"><input
								class="aa-cart-view-btn" type="button" value="更新購物車"></td>
...
<script
	src="<%=request.getContextPath()%>/front_end/product/js/bootstrap.js"></script>
<!-- SmartMenus jQuery plugin -->
<script type="text/javascript"
	src="<%=request.getContextPath()%>/front_end/product/js/jquery.smartmenus.js"></script>
<!-- SmartMenus jQuery Bootstrap Addon -->
<script type="text/javascript"
	src="<%=request.getContextPath()%>/front_end/product/js/jquery.smartmenus.bootstrap.js"></script>
<!-- To Slider JS -->
<script
	src="<%=request.getContextPath()%>/front_end/product/js/sequence.js"></script>
<!--   <script src="js/sequence-theme.modern-slide-in.js"></script>   -->
<!-- Product view slider -->
<script type="text/javascript"
	src="<%=request.getContextPath()%>/front_end/product/js/jquery.simpleGallery.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/front_end/product/js/jquery.simpleLens.js"></script>
<!-- slick slider -->
<script type="text/javascript"
	src="<%=request.getContextPath()%>/front_end/product/js/slick.js"></script>
<!-- Price picker slider -->
<script type="text/javascript"
	src="<%=request.getContextPath()%>/front_end/product/js/nouislider.js"></script>
<!-- Custom js -->
<script
	src="<%=request.getContextPath()%>/front_end/product/js/custom.js"></script>
