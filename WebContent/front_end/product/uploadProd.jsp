...
<!DOCTYPE html>
<link
	href="<%=request.getContextPath()%>/front_end/product/css/modify.css"
	rel="stylesheet">
<html lang="en">
							...
							<div class="aa-myaccount-login">
								...
								<form action="<%=request.getContextPath()%>/prod/ProdServlet"
									...
									<label for="">圖片一<span>*</span></label> <input type="file"
										class="file" id='file_id1' name='file_name1'
										accept="image/gif, image/jpeg, image/png"><br> <label
										for="">圖片二<span></span></label> <input type="file"
										class="file" id='file_id2' name='file_name2'
										accept="image/gif, image/jpeg, image/png"><br> <label
										for="">圖片三<span></span></label> <input type="file"
										id='file_id3' name='file_name3' class="file"
										accept="image/gif, image/jpeg, image/png"><br> <label
										for="">商品名稱<span>*</span></label> <input type="text"
										name="product_name" id="product_name" placeholder="請商品名稱"
										value="${prodVO.prodName }"> <label for="">商品類別<span>*</span></label>
									...
									<select id="cate_select" name="categorySelect"
										...
										<c:forEach varStatus="status" var="cateVO"
											...
											<option value="${cateVO.categoryID}"
												${(cateVO.categoryID==param.cate)?'selected':''}>${cateVO.categoryName}
										</c:forEach>
									</select> <br> <br> <br>


									<%-- 										<jsp:useBean id="prodSvc" scope="page" class="com.product.model.ProdService" /> --%>
									<label for="">商品租金<span>*</span></label> <input type="text"
										placeholder="請輸入商品租金" name="product_rent" id="product_rent"
										value="${prodVO.prodRent}"> <label for="">商品損壞賠償金<span>*</span></label>
									<input type="text" placeholder="請輸入商品損壞賠償金"
										name="product_price" id="product_price"
										value="${prodVO.prodPrice}"> <label for="">備註<span></span></label>
									<input type="text" placeholder="請輸入備註" name="comt" id="comt"
										value="${prodVO.comt}"> <label for="">商品內容<span>*</span></label>
									<input type="text" style="height: 150px; padding: 5px;"
										name="product_cot" value="${prodVO.prodCot}"> <input
										type=hidden id="fileCount" name="fileCount"><br>
									<input type="hidden" name="action" value="upload">
									<div>
										<input type="text" class="addLabel"
											style="size: 10px; width: 100px"> <input
											type="button" class="add-label-btn" value="自訂標籤"><br>
										標籤:&nbsp&nbsp <label><input type="checkbox"
											id="ps4" name="checkbox1" value="ps4">#ps4</label> <label><input
											id="" type="checkbox" name="checkbox1" value="ps5">#ps5</label>
										<label><input id="" type="checkbox" name="checkbox1"
											value="OLED">#OLED</label> <label><input id=""
											type="checkbox" name="checkbox1" value="瑪利歐">#瑪利歐</label> <label><input
											id="" type="checkbox" name="checkbox1" value="薩爾達">#薩爾達</label>
										<label><input id="" type="checkbox" name="checkbox1"
											value="賽車">#賽車</label> <label><input id=""
											type="checkbox" name="checkbox1" value="冒險">#冒險</label> <label><input
											id="" type="checkbox" name="checkbox1" value="動作">#動作</label><br>
...
<script type="text/javascript"
	src="<%=path%>/front_end/product/js/jquery.smartmenus.js"></script>
<!-- SmartMenus jQuery Bootstrap Addon -->
<script type="text/javascript"
	src="<%=path%>/front_end/product/js/jquery.smartmenus.bootstrap.js"></script>
<!-- To Slider JS -->
<script src="<%=path%>/front_end/product/js/sequence.js"></script>
<!--   <script src="js/sequence-theme.modern-slide-in.js"></script>   -->
<!-- Product view slider -->
<script type="text/javascript"
	src="<%=path%>/front_end/product/js/jquery.simpleGallery.js"></script>
<script type="text/javascript"
	src="<%=path%>/front_end/product/js/jquery.simpleLens.js"></script>
<!-- slick slider -->
<script type="text/javascript"
	src="<%=path%>/front_end/product/js/slick.js"></script>
<!-- Price picker slider -->
<script type="text/javascript"
	src="<%=path%>/front_end/product/js/nouislider.js"></script>
<!-- Custom js -->
