...
//coupon_id, promo_id, category_id, coupon_name, discount, amount, used, start_date, end_date
			try {
				...
				promolistVO = promoSvc.update(coupon_id, promo_id, category_id, coupon_name, discount, amount, used, start_date, end_date);
		...
		if ("insert".equals(action)) { // 來自add_promo.jsp的請求
			...
			try {
				...
				/*************************** 2.開始新增資料 ***************************************/
				PromolistService promolistSvc = new PromolistService();
				promolistVO = promolistSvc.insert(promo_id, category_id, coupon_name, discount, amount, used, start_date, end_date);
