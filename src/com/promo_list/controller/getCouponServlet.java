...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		if ("gameInsert".equals(action)) { // 來自getCoupon.jsp的請求
...
// Send the use back to the form, if there were errors
				...
				boolean b = memcouponSvc.insert(member_id, category_id, coupon_id, discount, coupon_name, status,
						start_date, end_date);

				/*************************** 3.新增完成,準備轉交(Send the Success view) ***********/
				String url = "/front_end/getCoupon/game.jsp";
...
//req.setAttribute("ok", "ok");
				...
				RequestDispatcher failureView = req.getRequestDispatcher("/front_end/getCoupon/game.jsp");
				failureView.forward(req, res);
			}
		}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if ("gameScore".equals(action))

		{ // 來自select_Promo.jsp的請求
...
//System.out.println("剩餘數量"+amount);
				...
				List<PromolistVO> promolistVO = promolistSvc.gameScore(amount);
